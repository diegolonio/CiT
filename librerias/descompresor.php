...
class Extractor {
     ...
     * @param $destination
     */
    public static function extract($archive, $tmp_filename, $destination){
        $ext = pathinfo($archive, PATHINFO_EXTENSION);
        switch ($ext){
            case 'zip':
                $res = self::extractZipArchive($tmp_filename, $destination);
                break;
            case 'gz':

                $res = self::extractGzipFile($tmp_filename, $destination);
                break;
            case 'rar':

                $res = self::extractRarArchive($tmp_filename, $destination);
                break;
        }
